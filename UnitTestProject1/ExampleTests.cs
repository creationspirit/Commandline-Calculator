...
namespace UnitTestProject1
{
    ...
    public class ExampleTests
    {
        ...
        public void CheckDisplay_PressMoreDigitsThenAllowed_FirstDigits()
        {
            ...
            string displayState = calculator.GetCurrentDisplayState();
            Assert.AreEqual("-12345,67891", displayState);
        }
        ...
        public void CheckDisplay_PressSinus_RoundedNumber()
        {
            ...
            string displayState = calculator.GetCurrentDisplayState();
            Assert.AreEqual("-0,993771636", displayState);
        }
        ...
        /// unarni se izračuna, ali se ne uzima u obzir u binarnoj operaciji (zbog 3)
        /// </summary>
        [TestMethod]
